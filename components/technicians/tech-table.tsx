...
export function TechTable({ technicians }: TechTableProps) {
    ...
    list.sort((a, b) => {
      ...
      switch (sortKey) {
        ...
        case "rating":
          ...
          break
        case "completedJobs":
          diff = a.completedJobs - b.completedJobs
          break
        case "avgResponseMin":
          diff = a.avgResponseMin - b.avgResponseMin
          break
      }
      ...
      <div className="rounded-xl border border-border bg-card shadow-sm overflow-hidden">
              ...
              <tr className="border-b border-border bg-muted/50">
                ...
                <th className="px-4 py-3 text-center font-medium text-muted-foreground">
                  <button type="button" onClick={() => toggleSort("avgResponseMin")} className="flex items-center justify-center gap-1 hover:text-foreground transition-colors">
                    Resp. Prom. <SortIcon col="avgResponseMin" />
                  </button>
                </th>
        ...
        <div className="flex items-center justify-between border-t border-border bg-muted/30 px-4 py-2.5">
          <span className="text-xs text-muted-foreground">
            Mostrando {filtered.length} de {technicians.length} tecnicos
          </span>
          <div className="flex items-center gap-3">
            <span className="text-xs text-muted-foreground">
